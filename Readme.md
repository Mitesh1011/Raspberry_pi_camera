...
How It Works
The Raspberry Pi camera captures live frames.
Each frame is converted into a MediaPipe-compatible format.
The TensorFlow Lite model performs object detection.
The system:
